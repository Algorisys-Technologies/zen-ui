...
const NewPaperDemo = () => (
  <DemoPage
    title="Paper"
    description="A document surface — a sheet you read, rather than a box you put things in. Card is the generic surface; reach for Paper when the content is prose and the reading is the point."
  >
    <DemoSection
  ...
  <PaperFooter>
    ...
    >
      <div class="zen-w-full zen-bg-zen-muted zen-p-8">
        <Paper>
          <PaperHeader>
            <PaperTitle>Kickoff notes</PaperTitle>
            <PaperDescription>Rajesh · 14 August</PaperDescription>
...
<Paper measure="full">…</Paper>    {/* fills its container */}`}
    >
      <div class="zen-w-full zen-flex zen-flex-col zen-gap-4 zen-bg-zen-muted zen-p-8">
        <Paper measure="prose" padding="sm">
          <PaperContent>
            <p class="zen-m-0">prose — 65ch. {BODY}</p>
          </PaperContent>
        </Paper>
        <Paper measure="wide" padding="sm">
          <PaperContent>
            <p class="zen-m-0">wide — 80ch. {BODY}</p>
          </PaperContent>
        </Paper>
        <Paper measure="full" padding="sm">
          <PaperContent>
            <p class="zen-m-0">full — fills the container. {BODY}</p>
          </PaperContent>
        </Paper>
      </div>
    </DemoSection>
...
<Paper elevation="lifted">…</Paper>`}
    >
      <div class="zen-w-full zen-grid zen-gap-6 zen-bg-zen-muted zen-p-8 sm:zen-grid-cols-3">
...
<Paper stack={2} elevation="lifted">…</Paper>`}
  ...
  …
    ...
    >
      <div class="zen-flex zen-flex-wrap zen-gap-2">
        <Dialog>
          <DialogTrigger as={Button}>Open a paper dialog</DialogTrigger>
          <DialogContent variant="paper">
            ...
            <div class="zen-text-base zen-leading-relaxed">
              <For each={Array.from({ length: 8 })}>{() => <p>{BODY}</p>}</For>
            </div>
            <DialogFooter>
        ...
        <Dialog>
          ...
          <DialogContent>
            ...
            <p class="zen-text-sm">Centred, capped at max-w-lg, scrolls inside itself.</p>
            <DialogFooter>
              <DialogClose as={Button} variant="ghost">
                Cancel
              </DialogClose>
  ...
  <Paper>…</Paper>
    ...
    >
      <div class="zen-w-full zen-grid zen-gap-6 sm:zen-grid-cols-2">
        <div class="zen-bg-zen-muted zen-p-6">
          <Paper measure="full" padding="sm">
            <PaperHeader>
        ...
        <div data-theme="paper" class="zen-bg-zen-muted zen-p-6">
          <Paper measure="full" padding="sm">
            <PaperHeader>
