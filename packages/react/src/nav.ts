...
export const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/gantt", label: "Gantt", description: "Project schedule \u2014 a collapsing task tree beside bars on a shared clock, with percent-complete fills, slip chips and dependency arrows", source: "packages/react/src/components/NewGanttDemo.tsx" },
