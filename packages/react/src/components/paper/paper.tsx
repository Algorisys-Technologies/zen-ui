...
const Paper = React.forwardRef<HTMLDivElement, PaperProps>(
  ({ className, measure, elevation, padding, stack, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        paperVariants({ measure, elevation, padding }),
        ...
        stack
          ? STACK_SHADOW[`${stack}-${elevation ?? "raised"}` as keyof typeof STACK_SHADOW]
          : undefined,
        className,
      )}
      {...props}
...
const PaperHeader = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn("zen-flex zen-flex-col zen-gap-1 zen-mb-6", className)} {...props} />
  ),
);
...
const PaperTitle = React.forwardRef<HTMLHeadingElement, PaperTitleProps>(
  ({ className, ...props }, ref) => (
...
const PaperDescription = React.forwardRef<
  HTMLParagraphElement,
  React.HTMLAttributes<HTMLParagraphElement>
>(({ className, ...props }, ref) => (
  <p ref={ref} className={cn("zen-m-0 zen-text-sm zen-text-zen-muted-fg", className)} {...props} />
));
PaperDescription.displayName = "PaperDescription";

const PaperContent = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      ...
      className={cn("zen-text-base zen-leading-relaxed zen-text-zen-foreground", className)}
      {...props}
    />
  ),
);
...
const PaperFooter = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
