/**
 * The pivot's public surface — components only.
 *
 * The model (layout, zones, filters, the server contract) comes from
 * @algorisys/zen-ui-core/pivot and is re-exported by the package root, so both
 * bindings hand consumers the same types from the same place.
 */
