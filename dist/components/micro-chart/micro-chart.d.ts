...
export declare const MicroLineChart: ({ values, area, width, height, color, label, className, }: MicroLineChartProps) => React.JSX.Element | null;
export interface MicroBarChartProps extends MicroChartBase {
    values: number[];
}
export declare const MicroBarChart: ({ values, width, height, color, label, className, }: MicroBarChartProps) => React.JSX.Element | null;
...
export declare const MicroBulletChart: ({ value, target, min, max, width, height, color, label, className, }: MicroBulletChartProps) => React.JSX.Element;
export interface MicroDeltaChartProps extends MicroChartBase {
    from: number;
    to: number;
}
export declare const MicroDeltaChart: ({ from, to, width, height, color, label, className, }: MicroDeltaChartProps) => React.JSX.Element;
...
export declare const MicroRadialChart: ({ value, max, showValue, width, height, color, label, className, }: MicroRadialChartProps) => React.JSX.Element;
export {};
