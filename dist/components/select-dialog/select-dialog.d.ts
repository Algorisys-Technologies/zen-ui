...
export declare const SelectDialog: {
    ({ open, onOpenChange, title, description, items, multiple, selectedIds, onConfirm, searchable, searchPlaceholder, onSearch, emptyText, confirmLabel, cancelLabel, clearLabel, showClearAll, className, }: SelectDialogProps): React.JSX.Element;
    displayName: string;
};
