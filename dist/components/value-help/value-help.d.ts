...
export declare const ValueHelp: {
    ({ open, onOpenChange, title, description, items, multiple, selectedIds, conditions, onConfirm, searchable, searchPlaceholder, onSearch, emptyText, confirmLabel, cancelLabel, selectTabLabel, conditionsTabLabel, addConditionLabel, className, }: ValueHelpProps): React.JSX.Element;
    displayName: string;
};
