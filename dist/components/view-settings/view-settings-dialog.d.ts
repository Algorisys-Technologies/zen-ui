...
export declare const ViewSettingsDialog: {
    ({ open, onOpenChange, title, description, sortItems, groupItems, filterGroups, value, onConfirm, confirmLabel, cancelLabel, resetLabel, sortTabLabel, groupTabLabel, filterTabLabel, className, }: ViewSettingsDialogProps): React.JSX.Element;
    displayName: string;
};
