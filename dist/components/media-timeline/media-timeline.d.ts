...
import { type MediaRange, type MediaRangeMode } from "../../_core/index";
/**
...
export declare const MediaTimeline: React.ForwardRefExoticComponent<MediaTimelineProps & React.RefAttributes<HTMLDivElement>>;
