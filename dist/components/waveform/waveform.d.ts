...
import { type WaveformClip } from "../../_core/index";
/**
...
export declare const Waveform: React.ForwardRefExoticComponent<WaveformProps & React.RefAttributes<HTMLDivElement>>;
