...
export declare const SelectSearchField: ({ value, onValueChange, placeholder, className, }: {
    value: string;
    onValueChange: (v: string) => void;
    placeholder?: string;
    className?: string;
}) => import("react").JSX.Element;
export declare const SelectListBody: ({ items, multiple, selected, onToggle, onPick, emptyText, }: {
