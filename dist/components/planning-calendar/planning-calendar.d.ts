...
import { type PlanningView } from "../../_core/index";
/**
...
export declare const PlanningCalendar: ({ rows, defaultView, view: viewProp, onViewChange, views, defaultDate, date: dateProp, onDateChange, onAppointmentClick, now: nowProp, hideToolbar, emptyMessage, className, }: PlanningCalendarProps) => React.JSX.Element;
