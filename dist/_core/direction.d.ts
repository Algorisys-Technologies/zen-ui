...
export declare function readDocumentDirection(): Direction;
/**
 ...
 * needs a reload.
 */
export declare function observeDocumentDirection(onChange: (dir: Direction) => void): () => void;
/**
 ...
 */
export declare function directionOf(el: Element | null | undefined): Direction;
/**
 ...
 */
export declare function horizontalStep(key: string, dir: Direction): -1 | 0 | 1;
/**
 ...
 */
export declare function arrowStep(key: string, el: Element | null | undefined): -1 | 0 | 1;
