 ...
 */
export declare const reduceReorder: (picked: PickedUp | null, action: ReorderAction, total: number) => ReorderResult;
/**
 ...
 */
export declare const keyToReorderAction: (key: string, orientation: ReorderOrientation, isPickedUp: boolean, total: number) => ReorderIntent | null;
/**
...
export declare const DEFAULT_REORDER_ANNOUNCEMENTS: ReorderAnnouncements;
